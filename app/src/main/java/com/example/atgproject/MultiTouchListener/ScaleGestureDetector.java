...
public class ScaleGestureDetector {
    ...
    public interface OnScaleGestureListener {
         ...
         * pointers going up.
         *
         * Once a scale has ended, {@link }
         * and {@link } will return the location
     ...
     * {@link OnScaleGestureListener#(ScaleGestureDetector)} returns
     * {@code false} so that a subclass can retrieve the accumulated scale
     * factor in an overridden onScaleEnd.
     * {@link OnScaleGestureListener#} returns
     * {@code true}.
     */
